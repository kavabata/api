...
module.exports = {
  ...
  insertSwitchByKey: async ({ key, state }) => {
    ...
    return module.exports.insertSwitchByDeviceId({ deviceId, state });
  },
  insertSwitchByDeviceId: ({ deviceId, state }) => {
    const getDb = require("./db").getDb;
    const db = getDb();
    const created = new Date();
    const insert = `INSERT INTO switch (device_id, state, created) VALUES 
